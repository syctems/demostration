...
(function (S, K) {
        ...
        a.Fx.prototype = {
            dSetter: function () {
                var a = this.paths[0],
                    ...
                    v;
                if (1 === t) l = this.toD;
                else if (n === f.length && 1 > t) for (; n--;) v = parseFloat(a[n]), l[n] = isNaN(v) ? f[n] : t * parseFloat(f[n] - v) + v;
                else l = f;
                this.elem.attr("d",
                l, null, !0)
            },
    ...
    (function (a) {
        ...
        h(B.prototype, {
            ...
            destroy: function () {
                var a = this,
                    g = a.element || {}, c = a.renderer.isSVG && "SPAN" === g.nodeName && a.parentGroup,
                    w = g.ownerSVGElement,
                    h = a.clipPath;
            ...
            zIndexSetter: function (a, c) {
                ...
                if (e) {
                    ...
                    e = y.zIndex, k = !u(e), y !== b) if (0 > a && k && !w && !p) h.insertBefore(b, c[p]), d = !0;
            ...
            buildText: function (a) {
                ...
                if (M !== a.textCache) {
                    ...
                    y || D || C || O || -1 !== b.indexOf(" ") ? (p = /<.*class="([^"]+)".*>/, x = /<.*style="([^"]+)".*>/, A = /<.*href="([^"]+)".*>/, L && L.appendChild(c), b = y ? b.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g,
                        ...
                        d(e, function (g) {
                            if ("" !== g || 1 === e.length) {
                                var d = {}, k = m.createElementNS(w.SVG_NS, "tspan"),
                                    r, L;
    ...
    var V = function (a) {
        ...
        a.extend(G.prototype, {
            ...
            defaultLabelFormatter: function () {
                ...
                else if (x && 1E3 <= g) for (; x-- && void 0 === r;) b = Math.pow(k, x + 1), g >= b && 0 === 10 * c % b && null !== p[x] && 0 !== c && (r = a.numberFormat(c / b, -1) + p[x]);
    ...
    (function (a) {
        ...
        B.prototype.getLogTickPositions = function (a, t, n, v) {
            ...
            else if (.08 <= a) for (var c = Math.floor(t), h, k,
            e, p, r, l = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; c < n + 1 && !r; c++) for (k = l.length, h = 0; h < k && !r; h++) e = m(b(c) * l[h]), e > t && (!v || p <= n) && void 0 !== p && d.push(p), p > n && (r = !0), p = e;
            ...
            renderSplit: function (c, b) {
                ...
                B(c.slice(0, b.length + 1), function (a, c) {
                    if (!1 !== a) {
                        ...
                        var l = c.series || m,
                            z = l.tt,
                            x = c.series || {}, F = "highcharts-color-" + t(c.colorIndex, x.colorIndex, "none");
        ...
        E(a.Pointer.prototype, {
            ...
            pinch: function (a) {
                var n = this,
                    ...
                    d = n.hasZoom,
                    h = n.selectionMarker,
                    k = {}, e = 1 === b && (n.inClass(a.target, "highcharts-tracker") && t.runTrackerClick || n.runChartClick),
                    p = {};
                1 < b && (n.initiated = !0);
        ...
        a.Series = a.seriesType("line", null, {
            ...
            setOptions: function (a) {
                var b = this.chart,
                    c = b.options,
                    d = c.plotOptions,
                    h = (b.userOptions || {}).plotOptions || {}, g = d[this.type];
                this.userOptions = a;
                b = e(g, d.series, a);
            ...
            setData: function (b, c, e, f) {
                ...
                if (!1 !== f && x && l === x && !m.cropped && !m.hasGroupedData && m.visible) v(b, function (a, b) {
                    ...
                    if (z && x > z) {
                        ...
                        if (h(n)) for (e = 0; e < x; e++) q[e] = this.autoIncrement(), D[e] = b[e];
                        else if (d(n)) if (t) for (e = 0; e < x; e++) n = b[e], q[e] = n[0], D[e] = n.slice(1, t + 1);
                        else for (e = 0; e < x; e++) n = b[e], q[e] = n[0], D[e] = n[1];
                        else a.error(12)
            ...
            processData: function (b) {
                ...
                if (p && this.sorted && !x && (!m || e > m || this.forceCrop)) if (c[e - 1] < z || c[0] > q) c = [], d = [];
            ...
            generatePoints: function () {
                ...
                this.options.keys = a;
                if (c && (k !== (d = c.length) || l)) for (r = 0; r < d; r++) r !== f || l || (r += k), c[r] && (c[r].destroyElements(), c[r].plotX = void 0);
                this.data = c;
                this.points = n
            },
            ...
            markerAttribs: function (a, b) {
                var c = this.options.marker,
                    e = a.marker || {}, d = e.symbol || c.symbol,
        ...
        m.pie && (m.pie.prototype.drawDataLabels = function () {
            ...
            c.visible && (l.enabled || c._hasPointLabels) && (q(d, function (a) {
                ...
                var h, k, n = b.length,
                    p = [],
                    r;
                if (n) for (c.sortByAngle(b, d - .5), 0 < c.maxLabelDistance && (h = Math.max(0, A - F - c.maxLabelDistance), k = Math.min(A + F + c.maxLabelDistance, f.plotHeight), q(b, function (a) {
        ...
        n(k.prototype, {
            ...
            setState: function (a, b) {
                var c = Math.floor(this.plotX),
                    ...
                    m = k && !1 === k.enabled,
                    p = k && k.states && k.states[a || "normal"] || {}, g = !1 === p.enabled,
                    q = e.stateMarkerGraphic,
                    r = this.marker || {}, t = e.chart,
                    u = e.halo,
        ...
        B.prototype.currentOptions = function (l) {
            ...
            b, l, d) {
                ...
                a.objectEach(c, function (a, c) {
                    if (!d && -1 < E(c, ["series", "xAxis", "yAxis"])) for (a = t(a), l[c] = [], h = 0; h < a.length; h++) b[c][h] && (l[c][h] = {}, n(a[h], b[c][h], l[c][h], d + 1));
