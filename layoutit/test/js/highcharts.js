...
(function(T, K) {
	...
	var K = function() {
			var a = "undefined" === typeof T ? window : T,
				...
				u = h && 4 > parseInt(E.split("Firefox/")[1], 10);
		...
		a.Fx.prototype = {
			dSetter: function() {
				var a = this.paths[0],
					...
					q;
				if (1 === u) e = this.toD;
				else if (y === h.length && 1 > u) for (; y--;) q = parseFloat(a[y]), e[y] = isNaN(q) ? h[y] : u * parseFloat(h[y] - q) + q;
				else e = h;
			...
			initPath: function(n, h, e) {
				...
				h.length && a.isNumber(x) && (l = e.length + x * p * r, I ? (y(h, e), q(e, h)) : (y(e, h), q(h, e)));
				return [h, e]
			}
		};
	...
	(function(a) {
		...
		a.Color.prototype = {
			...
			init: function(e) {
				...
				else if (e && e.charAt && "#" === e.charAt() && (h = e.length, e = parseInt(e.substr(1), 16), 7 === h ? y = [(e & 16711680) >> 16, (e & 65280) >> 8, e & 255, 1] : 4 === h && (y = [(e & 3840) >> 4 | (e & 3840) >> 8, (e & 240) >> 4 | e & 240, (e & 15) << 4 | e & 15, 1])), !y) for (q = this.parsers.length; q-- && !y;) x = this.parsers[q], (h = x.regex.exec(e)) && (y = x.parse(h));
				this.rgba = y || []
			},
			get: function(a) {
				var e = this.input,
	...
	(function(a) {
		...
		l(C.prototype, {
			...
			attr: function(a, g, b, d) {
				...
				"string" === typeof a ? l = (this[a + "Getter"] || this._defaultGetter).call(this, a, w) : (M(a, function(z, g) {
					m = !1;
					d || P(this, g);
					this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)$/.test(g) && (c || (this.symbolAttr(a), c = !0), m = !0);
			...
			zIndexSetter: function(a, b) {
				...
				if (c) {
					...
					b = z.childNodes;
					for (J = b.length - 1; 0 <= J && !m; J--) if (w = b[J], c = w.getAttribute("data-z-index"), f = !x(c), w !== l) if (0 > a && f && !d && !J) z.insertBefore(l, b[J]), m = !0;
					else if (g(c) <= a || f && (!x(a) || 0 <= a)) z.insertBefore(l, b[J + 1] || null), m = !0;
		...
		l(E.prototype, {
					...
					z || A || e || D || -1 !== l.indexOf(" ") ? (v && v.appendChild(d), l = z ? l.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [l], l = b(l, function(a) {
						...
						r(l, function(g) {
							if ("" !== g || 1 === l.length) {
								...
								(r = u(g, "href")) && !c && (h(v, "onclick", 'location.href\x3d"' + r + '"'), h(v, "class", "highcharts-anchor"), y(v, {
									cursor: "pointer"
								}));
								...
								if (" " !== g) {
									...
									if (D) {
										...
										var t = [],
											A, O = H(v),
											q = a.rotation;
										for (e && (f = w.applyEllipsis(a, v, g, D)); !e && r && (m.length || t.length);) a.rotation = 0, A = w.getSpanWidth(a, v), g = A > D, void 0 === f && (f = g), g && 1 !== m.length ? (v.removeChild(v.firstChild), t.unshift(m.pop())) : (m = t, t = [], m.length && !P && (v = k.createElementNS(J, "tspan"), h(v, {
											dy: O,
											x: B
			...
			image: function(a, g, b, d, w, c) {
				...
				c ? (J(f.element, "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw\x3d\x3d"), m = new N.Image, F(m, "load", z), m.src = a, m.complete && z({})) : J(f.element, a);
				return f
			},
			...
			label: function(g, b, d, c, m, f, J, v, B) {
				...
				L = function() {
					...
					u && (z || (p.box = z = k.symbols[c] || M ? k.symbol(c) : k.rect(), z.addClass(("button" === B ? "" : "highcharts-label-box") + (B ? " highcharts-" + B + "-box" : "")), z.add(p), a = n(), g.x = a, g.y = (v ? -y : 0) + a), g.width = Math.round(p.width), g.height = Math.round(p.height), z.attr(l(g, H)), H = {})
				};
				R = function() {
					var a = P + e,
						g;
			...
			htmlUpdateTransform: function() {
				if (this.added) {
					...
					if ("SPAN" === d.tagName) {
						...
						D !== this.cTT && (e = a.fontMetrics(d.style.fontSize).b, n(A) && A !== (this.oldRotation || 0) && this.setSpanRotation(A, r, e), this.getSpanCorrection(!n(A) && this.textPxLength || d.offsetWidth, e, r, A, t));
						F(d, {
	...
	var V = function(a) {
			...
			a.extend(G.prototype, {
				...
				defaultLabelFormatter: function() {
					...
					else if (m) k = d.dateFormat(m, b);
					else if (p && 1E3 <= g) for (; p-- && void 0 === k;) d = Math.pow(l, p + 1), g >= d && 0 === 10 * b % d && null !== f[p] && 0 !== b && (k = a.numberFormat(b / d, -1) + f[p]);
				...
				getPlotLinePath: function(a, b, d, c, m) {
					...
					p(m) ? this.horiz ? (f = l, J = k - this.bottom, a = d = B(a, w, w + this.width)) : (a = w, d = v - this.right, f = J = B(f, l, l + this.height)) : (e = !0, c = !1);
				...
				getMinorTickPositions: function() {
					...
					else for (b = p + (d[0] - p) % c; b <= l && b !== m[0]; b += c) m.push(b);
				...
				adjustForMinRange: function() {
					...
					d - b < this.minRange && (m = this.dataMax - this.dataMin >= this.minRange, B = this.minRange, c = (B - d + b) / 2, c = [b - c, H(a.min, b - c)], m && (c[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin), b = F(c), d = [b + B, H(a.max, b + B)], m && (d[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax), d = n(d), d - b < B && (c[0] = d - B, c[1] = H(a.min, d - B), b = F(c)));
					this.min = b;
					this.max = d
				},
				getClosest: function() {
				...
				nameToX: function(a) {
					...
					y(c) || (c = !1 === this.options.uniqueNames ? a.series.autoIncrement() : g ? b(a.name, d) : H(d.keys[a.name], -1)); - 1 === c ? g || (m = d.length) : m = c;
				...
				setTickInterval: function(b) {
					...
					m && (g.positiveValuesOnly && !b && 0 >= Math.min(g.min, H(g.dataMin, g.min)) && a.error(10, 1), g.min = e(g.log2lin(g.min), 15), g.max = e(g.log2lin(g.max), 15));
				...
				renderUnsquish: function() {
					...
					if (this.autoRotation) h > v && h > e.h ? B.rotation = this.labelRotation : this.labelRotation = 0;
					else if (k && (r = v, !t)) for (D = "clip", v = d.length; !p && v--;) if (A = d[v], A = c[A].label) A.styles && "ellipsis" === A.styles.textOverflow ? A.css({
						textOverflow: "clip"
				...
				render: function() {
					...
					e && q && (c = b.getTitlePosition(), p(c.y) ? (e[e.isNew ? "attr" : "animate"](c), e.isNew = !1) : (e.attr("y", -9999), e.isNew = !0));
	...
	(function(a) {
		...
		C.prototype.getLogTickPositions = function(a, u, y, q) {
			...
			else if (.08 <= a) for (var f = Math.floor(u), k, r, l, d, b, e = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < y + 1 && !b; f++) for (r = e.length, k = 0; k < r && !b; k++) l = this.log2lin(this.lin2log(f) * e[k]), l > u && (!q || d <= y) && void 0 !== d && c.push(d), d > y && (b = !0), d = l;
	...
	(function(a) {
		...
		a.Tooltip.prototype = {
			...
			getAnchor: function(a, f) {
				...
				a = q(a);
				c = a[0].tooltipPos;
				this.followPointer && f && (void 0 === f.chartX && (f = l.pointer.normalize(f)), c = [f.chartX - l.plotLeft, f.chartY - b]);
				c || (E(a, function(a) {
					t = a.series.yAxis;
					h = a.series.xAxis;
	...
	(function(a) {
		...
		F(a.Pointer.prototype, {
			...
			touch: function(h, n) {
				...
				1 === h.touches.length ? (h = this.normalize(h), (f = q.isInsidePlot(h.chartX - q.plotLeft, h.chartY - q.plotTop)) && !q.openMenu ? (n && this.runPointActions(h), "touchmove" === h.type && (n = this.pinchDown, u = n[0] ? 4 <= Math.sqrt(Math.pow(n[0].chartX - h.chartX, 2) + Math.pow(n[0].chartY - h.chartY, 2)) : !1), e(u, !0) && this.pinch(h)) : n && this.reset()) : 2 === h.touches.length && this.pinch(h)
			},
		...
		a.Legend.prototype = {
			...
			layoutItem: function(a) {
				var c = this.options,
					...
					c = c.alignColumns && this.totalItemWidth > q ? this.maxItemWidth : a.itemWidth;
	...
	(function(a) {
		...
		a.Point.prototype = {
			...
			optionsToObject: function(f) {
				...
				else if (u(f)) for (!h && f.length > d && (e = typeof f[0], "string" === e ? c.name = f[0] : "number" === e && (c.x = f[0]), b++); n < d;) h && void 0 === f[b] || (0 < l[n].indexOf(".") ? a.Point.prototype.setNestedProperty(c, f[b], l[n]) : c[l[n]] = f[b]), b++, n++;
	...
	(function(a) {
		...
		a.Series = a.seriesType("line", null, {
			...
			setData: function(b, c, f, e) {
				...
				if (!H) {
					...
					if (n && k > n) {
						...
						if (l(t)) for (f = 0; f < k; f++) v[f] = this.autoIncrement(), u[f] = b[f];
						else if (r(t)) if (y) for (f = 0; f < k; f++) t = b[f], v[f] = t[0], u[f] = t.slice(1, y + 1);
						else for (f = 0; f < k; f++) t = b[f], v[f] = t[0], u[f] = t[1];
						else a.error(12)
			...
			processData: function(b) {
				...
				if (r && this.sorted && !p && (!l || f > l || this.forceCrop)) if (c[f - 1] < n || c[0] > q) c = [], d = [];
			...
			generatePoints: function() {
				...
				for (A = 0; A < h; A++) k = l + A, p ? (r = (new e).init(this, [f[A]].concat(t(g[A]))), r.dataGroup = this.groupMap[A]) : (r = c[k]) || void 0 === b[k] || (c[k] = r = (new e).init(this, b[k], f[A])), r && (r.index = k, n[A] = r);
				this.options.keys = a;
			...
			getExtremes: function(a) {
				...
				d = a.length;
				for (A = 0; A < d; A++) if (k = c[A], t = a[A], h = (l(t, !0) || r(t)) && (!b.positiveValuesOnly || t.length || 0 < t), k = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[A + p] || k) >= m && (c[A - p] || k) <= e, h && k) if (h = t.length) for (; h--;)"number" === typeof t[h] && (f[g++] = t[h]);
				else f[g++] = t;
				this.dataMin = n(f);
				this.dataMax = F(f)
			},
			translate: function() {
				...
				for (a = 0; a < k; a++) {
					...
					b && this.visible && !L.isNull && F && F[C] && (x = this.getStackIndicator(x, C, this.index), K = F[C], E = K.points[x.key], u = E[0], E = E[1], u === q && x.key === F[C].base && (u = p(l(n) && n, e.min)), e.positiveValuesOnly && 0 >= u && (u = null), L.total = L.stackTotal = K.total, L.percentage = K.total && L.y / K.total * 100, L.stackY = E, K.setOffset(this.pointXOffset || 0, this.barW || 0));
			...
			setClip: function(a) {
				...
				a || (h.count[this.index] && (delete h.count[this.index], --h.count.length), 0 === h.count.length && m && b[m] && (g || (b[m] = b[m].destroy()), b[m + "m"] && (b[m + "m"] = b[m + "m"].destroy())))
			},
			animate: function(a) {
				var b = this.chart,
			...
			drawPoints: function() {
				...
				if (!1 !== e.enabled || this._hasPointMarkers) for (c = 0; c < a.length; c++) d = a[c], g = d.graphic, h = d.marker || {}, l = !! d.marker, f = A && void 0 === h.enabled || h.enabled, k = d.isInside, f && !d.isNull ? (f = p(h.symbol, this.symbol), t = this.markerAttribs(d, d.selected && "select"), g ? g[k ? "show" : "hide"](!0).animate(t) : k && (0 < t.width || d.hasImage) && (d.graphic = g = b.renderer.symbol(f, t.x, t.y, t.width, t.height, l ? h : e).add(r)), g && g.attr(this.pointAttribs(d, d.selected && "select")), g && g.addClass(d.getClassName(), !0)) : g && (d.graphic = g.destroy())
			},
			...
			getGraphPath: function(a, b, c) {
				...
				q(a, function(e, k) {
					...
					e.isNull && !y(b) && 0 < k ? l = !f.connectNulls : e.isNull && !b ? l = !0 : (0 === k || l ? k = ["M", e.plotX, e.plotY] : d.getPointSpline ? k = d.getPointSpline(a, e, k) : g ? (k = 1 === g ? ["L", t.plotX, r] : 2 === g ? ["L", (t.plotX + p) / 2, t.plotY, "L", (t.plotX + p) / 2, r] : ["L", p, t.plotY], k.push("L", p, r)) : k = ["L", p, r], h.push(e.x), g && (h.push(e.x), 2 === g && h.push(e.x)), m.push.apply(m, k), l = !1)
				});
				m.xMap = h;
			...
			update: function(a, h, m, k) {
				...
				u("xAxis yAxis zAxis series colorAxis pane".split(" "), function(b) {
					...
					a[b] && ("series" === b && (c = [], u(t[b], function(a, b) {
						...
						if (!d && m) if ("series" === b) t.addSeries(a, !1).touched = !0;
	...
	(function(a) {
		...
		q("column", "line", {
			...
			pointAttribs: function(a, c) {
				...
				c && (a = e(f.states[c], a.options.states && a.options.states[c] || {}), c = a.brightness, b = a.color || void 0 !== c && E(b).brighten(a.brightness).get() || b, n = a[h] || n, p = a[d] || p, l = a.dashStyle || l);
				h = {
					fill: b,
					stroke: n,
					"stroke-width": p
		...
		k.pie && (k.pie.prototype.drawDataLabels = function() {
			...
			d.visible && (h.enabled || d._hasPointLabels) && (n(b, function(a) {
				...
				if ((g = a.dataLabel) && g._pos && a.visible && 0 < a.labelDistance) {
					...
					if (b = !u) a.connector = u = f.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + a.colorIndex + (a.className ? " " + a.className : "")).add(d.dataLabelsGroup), u.attr({
						"stroke-width": k,
	...
	(function(a) {
		...
		C.prototype.hideOverlappingLabels = function(a) {
			...
			for (n = 0; n < e; n++) for (c = (q = a[n]) && q.absoluteBox, h = n + 1; h < e; ++h) if (f = (x = a[h]) && x.absoluteBox, c && f && q !== x && 0 !== q.newOpacity && 0 !== x.newOpacity && (f = k(c.x, c.y, c.width, c.height, f.x, f.y, f.width, f.height)))(q.labelrank < x.labelrank ? q : x).newOpacity = 0;
			E(a, function(a) {
				var c, d;
				...
				if (!(a === this.state && !b || this.selected && "select" !== a || !1 === h.enabled || a && (g || n && !1 === p.enabled) || a && r.states && r.states[a] && !1 === r.states[a].enabled)) {
					...
					if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.animate(f.pointAttribs(this, a), l(u.options.chart.animation, h.animation)), x && this.graphic.animate(x, l(u.options.chart.animation, p.animation, k.animation)), t && t.hide();
						...
						if (a && p) {
							...
							else k && (f.stateMarkerGraphic = t = u.renderer.symbol(k, x.x, x.y, x.width, x.height).add(f.markerGroup), t.currentSymbol = k);
		...
		C.prototype.currentOptions = function(e) {
			function q(e, c, k, r) {
				...
				a.objectEach(e, function(a, b) {
					if (!r && -1 < F(b, ["series", "xAxis", "yAxis"])) for (a = u(a), k[b] = [], f = 0; f < a.length; f++) c[b][f] && (k[b][f] = {}, q(a[f], c[b][f], k[b][f], r + 1));
